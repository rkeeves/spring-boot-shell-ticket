Feature: allows creating movie descriptions
  ...
  Scenario: a not signed in user cannot create, delete or update movies
    Then the "create movie" shell command is not available
    Then the "delete movie" shell command is not available
    Then the "update movie" shell command is not available

  Scenario: a non-privileged user cannot create, delete or update movies
