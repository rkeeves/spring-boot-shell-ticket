Feature: allow creating, reading, updating and deleting rooms where the screenings will happen
  ...
  Scenario: a not signed in user cannot create, delete or update rooms
    Then the "create room" shell command is not available
    Then the "delete room" shell command is not available
    Then the "update room" shell command is not available

  Scenario: a non-privileged user cannot create, delete or update rooms
